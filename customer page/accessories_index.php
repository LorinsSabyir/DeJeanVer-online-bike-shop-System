...
$prodType = $productController->readByType(3);
...
<head>
  ...
  <style>
    .bg-cover {
      background-image: url('../website\ images/bike-tools-2.jpg');
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-5">
            ...
            <li class="nav-item">
              <a class="nav-link mx-4 active" href="accessories_index.php">Accessories</a>
            </li>
            <li class="nav-item">
