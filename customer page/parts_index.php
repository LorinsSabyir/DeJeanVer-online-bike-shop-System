...
$prodType = $productController->readByType(4);
...
<head>
  ...
  <style>
    .bg-cover {
      background-image: url('../website\ images/bike-tools-1.jpg');
...
<body style="font-family: 'Ropa Sans', sans-serif !important;">
  ...
  <header class="header_section fixed-top ">
    ...
    <div class="container-fluid bg-black justify-content-end d-flex justify-content-end p-0 align-items-center">
      ...
      <a href="login_index.php" class="btn bg-dark rounded-0 text-white-50 px-5 mx-2" role="button" data-bs-toggle="button">SIGN IN</a>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-5">
            ...
            <li class="nav-item">
              <a class="nav-link mx-4 active" href="parts_index.php">Parts</a>
            </li>
            <li class="nav-item">
                  ...
                  <div class="d-flex justify-content-between mt-auto">
                    ...
                    <div class="cart p-2">
                      <form method="post" class="box" action="">
                        <input type="hidden" name="product_name" value="<?php echo htmlspecialchars($product['prodName']); ?>">
                        <input type="hidden" name="product_price" value="<?php echo htmlspecialchars($product['prodPrice']); ?>">
                        <input type="hidden" name="product_image" value="<?php echo htmlspecialchars($product['prodImg']); ?>">
