...
$prodType = $productController->readByType(2);
...
<head>
  ...
  <style>
    .bg-cover {
      background-image: url('../website\ images/bike-tools.jpg');
...
<body style="font-family: 'Ropa Sans', sans-serif !important;">
  ...
  <header class="header_section fixed-top ">
    ...
    <div class="container-fluid bg-black justify-content-end d-flex justify-content-end p-0 align-items-center">
      ...
      <a class="btn btn-secondary rounded-0 text-white-50 px-5 mx-2" href="../#5BAEB7login_index.php" role="button">SIGN IN</a>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-5">
            ...
            <li class="nav-item">
              <a class="nav-link mx-4 active" href="tools_index.php">Tools</a>
            </li>
          </ul>
