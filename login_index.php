<?php
// Login connection
include "backend/login_cont.php";
?>
  ...
  <main class="d-flex align-items-center bg-body-tertiary justify-content-center h-100">
    <div class="form-signin border rounded my-5 py-5 w-75" style="max-width: 400px;">
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="form-check text-start my-3 p-0 text-center">
          <p class="m-0">Don't have an account?</p>
          <a href="register_index.php">Sign up now</a>
          <p class="m-0"><a href="admin page/admin_login_index.php">Admin?</a></p>
        </div>
