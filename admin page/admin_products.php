        ...
        <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2 active" href="admin_products.php">
                  <svg class="bi">
                    <use xlink:href="#cart" />
                  </svg>
                  All Products
              ...
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="admin_prodType.php">
                  <svg class="bi">
                    <use xlink:href="#cart" />
                  </svg>
                  Products by Type
